...
public class SpecialistViewMessagePane extends Pane {
    ...
    public SpecialistViewMessagePane(Message message) {
        ...
        fromInfoLabel = new Label(HealthCarePortalSystem.findPatientByID(message.getSenderID()).getFirstName() + " " + HealthCarePortalSystem.findPatientByID(message.getSenderID()).getLastName());
        ...
        fromInfoLabel2 = new Label(HealthCarePortalSystem.findPatientByID(message.getSenderID()).getFirstName() + " " + HealthCarePortalSystem.findPatientByID(message.getSenderID()).getLastName());
